...
using DotNetElements.Wpf.Markdown.Tests.TestHelper;
...
[StaTestClass]
[UsesVerify]
public sealed partial class DocumentMarkdownWriterSnapshotTests
{
    [TestMethod]
    public async Task RendersMarkdownCorrectly()
    {
        ...
        await Verify(document.Document.ToPrettyXaml()).UseDirectory("SnapshotResults");
    }
